...
Для тестирования работы предоставлен доступ к обработанным данным

Отобранные ключевые кадры, что использовались для формирования клипов, хранятся в: [Открыть ключевые кадры](https://drive.google.com/drive/folders/12B1ixBA5la8EARAB5XKmRnsF-Tg8guIJ?usp=sharing)

10 клипов со сложными сценами и нужными классами объектов. Они уже готовы к разметке: [Открыть отобранные клипы для аннотации](https://drive.google.com/drive/folders/1PZwSLR4qRzrMdJqezerzbGgIOx7rM4WL?usp=sharing)
